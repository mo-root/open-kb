...
const TOTAL = 25.4;
/* How much scroll buys the whole film. ~18 viewports ≈ 1.4s of film per
   screen — heavy enough that the fast beats (the ticker rip, the
   detonation) still read frame by frame instead of blurring past. */
const TRACK_VH = 1800;
