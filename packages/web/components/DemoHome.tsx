  ...
  return (
    <div className="mx-auto max-w-6xl px-5 py-8">
      <div className="mb-6">
        ...
        {/* The old line in this slot was a price list: "a question reads 4
            result pages at $0.0015 each", quoted at a reader who had no way to
            buy one. Same slot, same type, and now it is a fact about the six
            maps directly beneath it — what they hold and what they cost, all of
            it already spent. */}
        {shown.length > 0 && (
      ...
      {/* The secondary action, and the whole of what used to be the page's
          opening paragraph. It sits under the maps because that is the order
          the reader needs it in: see the thing work, then learn how to have
          one. The link is the answer, so the sentence does not describe it. */}
